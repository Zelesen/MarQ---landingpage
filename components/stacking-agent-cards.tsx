...
const AGENTS = [
  {
    label: "LLAMA 3.1 8B",
    title: "Quantized Llama Series",
    desc: "Optimized weights for GGUF, GPTQ, and AWQ formats. Validated for high-precision local inference on consumer hardware.",
    stats: [{ v: "4.1 GB", l: "smallest" }, { v: "6.84", l: "perplexity" }],
    img: "/images/researcher.webp",
  },
  {
    label: "MISTRAL 7B",
    title: "Mistral v0.3 Optimized",
    desc: "The industry standard for 7B parameter efficiency. Available in all Q4, Q5, and FP16 quantization levels for every runtime.",
    stats: [{ v: "3.8 GB", l: "smallest" }, { v: "6.71", l: "perplexity" }],
    img: "/images/coder.webp",
  },
  {
    label: "PHI-3 MINI",
    title: "Microsoft Edge weights",
    desc: "State-of-the-art small language model. Full support for TFLite and CoreML for high-speed mobile and web deployment.",
    stats: [{ v: "2.2 GB", l: "smallest" }, { v: "7.12", l: "perplexity" }],
    img: "/images/analyst.webp",
  },
  {
    label: "MOONDREAM 2",
    title: "Vision LM Optimized",
    desc: "Extremely lightweight vision-language model. Optimized for real-time image analysis on local mobile and IoT edge devices.",
    stats: [{ v: "980 MB", l: "smallest" }, { v: "74.2", l: "VQA score" }],
