...
const STEPS = [
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Install the MarQ CLI" },
      { type: "command", text: "npm install -g MarQ" },
      { type: "gap" },
      { type: "comment", text: "# Initialize your project" },
      { type: "command", text: "npx MarQ init" },
      { type: "gap" },
      { type: "output", text: "✓ Project initialized" },
      { type: "output", text: "✓ Registry config created" },
  ...
  },
  {
    num: "02",
    title: "Select Model",
    desc: "Search the verified registry",
    file: "models/llama3.ts",
    lang: "typescript",
    code: [
      { type: "comment", text: "// models/llama3.ts" },
      { type: "keyword", text: "import", after: " { Model, Format } ", keyword2: "from", string: " '@MarQ/registry'" },
      { type: "gap" },
      { type: "keyword", text: "const", after: " llama ", keyword2: "=", keyword3: " new ", fn: "Model", args: "('llama-3.1-8b')" },
      { type: "gap" },
      { type: "keyword", text: "export const", after: " weights ", keyword2: "=", keyword3: " await ", fn: "llama", args: ".fetch({" },
      { type: "prop", key: "  format", val: "'gguf'" },
      { type: "prop", key: "  method", val: "'q4_k_m'" },
      { type: "prop", key: "  verify", val: "true" },
      { type: "prop", key: "  shards", val: "auto" },
      { type: "plain", text: "});" },
    ],
  },
  {
    num: "03",
    title: "Verify Weights",
    desc: "Automated integrity checks",
    file: "pipeline/verify.ts",
    lang: "typescript",
    code: [
      { type: "comment", text: "// Run automated validation" },
      { type: "keyword", text: "import", after: " { Validator } ", keyword2: "from", string: " '@MarQ/validator'" },
      { type: "gap" },
      { type: "keyword", text: "const", after: " status ", keyword2: "=", keyword3: " await ", fn: "Validator", args: ".check(weights, {" },
      { type: "prop", key: "  metric", val: "'perplexity'" },
      { type: "prop", key: "  target", val: "'wiki-text-2'" },
      { type: "plain", text: "})" },
      { type: "gap" },
      { type: "comment", text: "// Output accuracy log" },
      { type: "plain", text: "console.log(status.report)" },
    ],
  },
  {
    num: "04",
    title: "Local Run",
    desc: "Run on constrained hardware",
    file: "terminal",
    lang: "bash",
    code: [
      { type: "comment", text: "# Execute local inference" },
      { type: "command", text: "MarQ run llama-3.1 --local" },
      { type: "gap" },
      { type: "output", text: "  Loading weights..." },
      { type: "output", text: "  Detecting hardware: Metal (M3 Max)" },
      { type: "output", text: "  Starting inference server..." },
      { type: "gap" },
      { type: "success", text: "✓ Model ready at :8080" },
      { type: "url", text: "  → https://localhost:8080/v1/chat" },
    ],
  },
]
